...
class QMongo:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Qgis-Mongo-Connector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QMongo', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/QMongoConnector/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGIS MongoDB Connector'),
            callback=self.run,
